...
The installer will prompt for your admin password and schedule configuration.
...
2. **API call** to GLKVM enables/disables the built-in mouse jiggler
...
```bash
wget -qO- https://raw.githubusercontent.com/NoBloodyABCorD/comet-jiggler-scheduler/main/uninstall.sh | sh
```
